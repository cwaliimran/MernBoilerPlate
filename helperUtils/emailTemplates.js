// emailTemplate.js
const APP_NAME = "Borrow App"; // Define the app name as a constant at the top
	...
	<tr>
		<td colspan="2" style="padding:20px 20px 20px 20px">
			...
			<p style="font-family: 'Montserrat', sans-serif;font-size: 15px;text-align: justify;">
				You’re almost ready to start a whole new borrow experience
			</p>
			<p style="font-family: 'Montserrat', sans-serif;font-size: 15px;text-align: justify;">
			...
			<p style="font-family: 'Montserrat', sans-serif; font-size: 15px;">
				We wish you a Borrow experience
			</p>
         <p style="font-family: 'Montserrat', sans-serif; font-size: 15px;">
        Best Regards,
        <br>
